...
public class SkillClientController {
    ...
    @Operation(summary = "nacos.admin.ai.skill.client.api.search.summary",
        description = "nacos.admin.ai.skill.client.api.search.description",
        security = @SecurityRequirement(name = "nacos"))
    @ApiResponse(responseCode = "200",
        content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,
            schema = @Schema(implementation = Result.class,
                example = "nacos.admin.ai.skill.client.api.search.example")))

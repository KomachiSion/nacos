...
/**
 * Generic AI Resource Search Client HTTP API.
 *
 * @author Nacos
 */
@NacosApi
...
public class AiResourceSearchClientController {
    ...
    public AiResourceSearchClientController(AiResourceSearchApplicationService searchService) {
        this.searchService = searchService;
    }
    
    /**
     * Search visible current AI Resources across one or more types.
     */
    @Since("3.3.0")
    @GetMapping
    ...
    public Result<AiResourceSearchResponse> search(AiResourceSearchForm form)
        ...
        form.validate();
        return Result.success(searchService.search(form));
    }
}

...
@Tag(name = "nacos.admin.ai.agent.api.controller.name",
    description = "nacos.admin.ai.agent.api.controller.description", extensions = {
...
public class AgentAdminController {
    ...
    @Operation(summary = "nacos.admin.ai.agent.api.get.summary",
        description = "nacos.admin.ai.agent.api.get.description",
        security = @SecurityRequirement(name = "nacos"))
    @ApiResponse(responseCode = "200",
        content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,
            schema = @Schema(implementation = Result.class,
                example = "nacos.admin.ai.agent.api.get.example")))
    ...
    @Operation(summary = "nacos.admin.ai.agent.api.update.summary",
        description = "nacos.admin.ai.agent.api.update.description",
        security = @SecurityRequirement(name = "nacos"))
    @ApiResponse(responseCode = "200",
        content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,
            schema = @Schema(implementation = Result.class,
                example = "nacos.admin.ai.agent.api.update.example")))
    @Parameters(value = {@Parameter(name = "namespaceId", example = "public"),
        @Parameter(name = "agentName", required = true, example = "my-agent"),
    ...
    @DeleteMapping
    @Secured(action = ActionTypes.WRITE, signType = SignType.AI, apiType = ApiType.ADMIN_API)
    @Operation(summary = "nacos.admin.ai.agent.api.delete.summary",
        description = "nacos.admin.ai.agent.api.delete.description",
        security = @SecurityRequirement(name = "nacos"))
    @ApiResponse(responseCode = "200",
        content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,
            schema = @Schema(implementation = Result.class,
                example = "nacos.admin.ai.agent.api.delete.example")))
    @Parameters(value = {@Parameter(name = "namespaceId", example = "public"),
        @Parameter(name = "agentName", required = true, example = "my-agent"),
        @Parameter(name = "form", hidden = true)})
    ...
    @GetMapping("/list")
    @Secured(action = ActionTypes.READ, signType = SignType.AI, apiType = ApiType.ADMIN_API)
    @Operation(summary = "nacos.admin.ai.agent.api.list.summary",
        description = "nacos.admin.ai.agent.api.list.description",
        security = @SecurityRequirement(name = "nacos"))
    @ApiResponse(responseCode = "200",
        content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,
            schema = @Schema(implementation = Result.class,
                example = "nacos.admin.ai.agent.api.list.example")))
    @Parameters(value = {@Parameter(name = "namespaceId", example = "public"),
    ...
    @GetMapping("/versions")
    @Secured(action = ActionTypes.READ, signType = SignType.AI, apiType = ApiType.ADMIN_API)
    @Operation(summary = "nacos.admin.ai.agent.api.versions.summary",
        description = "nacos.admin.ai.agent.api.versions.description",
        security = @SecurityRequirement(name = "nacos"))
    @ApiResponse(responseCode = "200",
        content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,
            schema = @Schema(implementation = Result.class,
                example = "nacos.admin.ai.agent.api.versions.example")))
    @Parameters(value = {@Parameter(name = "namespaceId", example = "public"),
        @Parameter(name = "agentName", required = true, example = "my-agent"),
    ...
    @GetMapping("/version")
    @Secured(action = ActionTypes.READ, signType = SignType.AI, apiType = ApiType.ADMIN_API)
    @Operation(summary = "nacos.admin.ai.agent.api.get.version.summary",
        description = "nacos.admin.ai.agent.api.get.version.description",
        security = @SecurityRequirement(name = "nacos"))
    @ApiResponse(responseCode = "200",
        content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,
            schema = @Schema(implementation = Result.class,
                example = "nacos.admin.ai.agent.api.get.version.example")))
    @Parameters(value = {@Parameter(name = "namespaceId", example = "public"),
        @Parameter(name = "agentName", required = true, example = "my-agent"),
    ...
    @Secured(action = ActionTypes.READ, signType = SignType.AI, apiType = ApiType.ADMIN_API)
    @Operation(summary = "nacos.admin.ai.agent.api.runtime.endpoints.get.summary",
        description = "nacos.admin.ai.agent.api.runtime.endpoints.get.description",
        security = @SecurityRequirement(name = "nacos"))
    @ApiResponse(responseCode = "200",
        content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,
            schema = @Schema(implementation = Result.class,
                example = "nacos.admin.ai.agent.api.runtime.endpoints.get.example")))
    @Parameters(value = {@Parameter(name = "namespaceId", example = "public"),
        @Parameter(name = "agentName", required = true, example = "my-agent"),
    ...
    @PostMapping("/draft")
    @Secured(action = ActionTypes.WRITE, signType = SignType.AI, apiType = ApiType.ADMIN_API)
    @Operation(summary = "nacos.admin.ai.agent.api.draft.create.summary",
        description = "nacos.admin.ai.agent.api.draft.create.description",
        security = @SecurityRequirement(name = "nacos"))
    @ApiResponse(responseCode = "200",
        content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,
            schema = @Schema(implementation = Result.class,
                example = "nacos.admin.ai.agent.api.draft.create.example")))
    @Parameters(value = {@Parameter(name = "namespaceId", example = "public"),
        @Parameter(name = "agentName", required = true, example = "my-agent"),
        @Parameter(name = "version", required = true, example = "1.0.0"),
        @Parameter(name = "displayName", example = "My Agent"),
    ...
    @PutMapping("/draft")
    @Secured(action = ActionTypes.WRITE, signType = SignType.AI, apiType = ApiType.ADMIN_API)
    @Operation(summary = "nacos.admin.ai.agent.api.draft.update.summary",
        description = "nacos.admin.ai.agent.api.draft.update.description",
        security = @SecurityRequirement(name = "nacos"))
    @ApiResponse(responseCode = "200",
        content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,
            schema = @Schema(implementation = Result.class,
                example = "nacos.admin.ai.agent.api.draft.update.example")))
    @Parameters(value = {@Parameter(name = "namespaceId", example = "public"),
        @Parameter(name = "agentName", required = true, example = "my-agent"),
        @Parameter(name = "version", required = true, example = "1.0.0"),
        @Parameter(name = "callInterfaces", required = true,
            description = "Call interface JSON array"),
        @Parameter(name = "changeDescription", example = "Update endpoint"),
        @Parameter(name = "form", hidden = true)})
    ...
    @DeleteMapping("/draft")
    @Secured(action = ActionTypes.WRITE, signType = SignType.AI, apiType = ApiType.ADMIN_API)
    @Operation(summary = "nacos.admin.ai.agent.api.draft.delete.summary",
        description = "nacos.admin.ai.agent.api.draft.delete.description",
        security = @SecurityRequirement(name = "nacos"))
    @ApiResponse(responseCode = "200",
        content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,
            schema = @Schema(implementation = Result.class,
                example = "nacos.admin.ai.agent.api.draft.delete.example")))
    @Parameters(value = {@Parameter(name = "namespaceId", example = "public"),
        @Parameter(name = "agentName", required = true, example = "my-agent"),
        @Parameter(name = "version", required = true, example = "1.0.0"),
        @Parameter(name = "form", hidden = true)})
    ...
    @PostMapping("/submit")
    @Secured(action = ActionTypes.WRITE, signType = SignType.AI, apiType = ApiType.ADMIN_API)
    @Operation(summary = "nacos.admin.ai.agent.api.submit.summary",
        description = "nacos.admin.ai.agent.api.submit.description",
        security = @SecurityRequirement(name = "nacos"))
    @ApiResponse(responseCode = "200",
        content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,
            schema = @Schema(implementation = Result.class,
                example = "nacos.admin.ai.agent.api.submit.example")))
    @Parameters(value = {@Parameter(name = "namespaceId", example = "public"),
        @Parameter(name = "agentName", required = true, example = "my-agent"),
        @Parameter(name = "version", required = true, example = "1.0.0"),
        @Parameter(name = "form", hidden = true)})
    ...
    @PostMapping("/publish")
    @Secured(action = ActionTypes.WRITE, signType = SignType.AI, apiType = ApiType.ADMIN_API)
    @Operation(summary = "nacos.admin.ai.agent.api.publish.summary",
        description = "nacos.admin.ai.agent.api.publish.description",
        security = @SecurityRequirement(name = "nacos"))
    @ApiResponse(responseCode = "200",
        content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,
            schema = @Schema(implementation = Result.class,
                example = "nacos.admin.ai.agent.api.publish.example")))
    @Parameters(value = {@Parameter(name = "namespaceId", example = "public"),
        @Parameter(name = "agentName", required = true, example = "my-agent"),
        @Parameter(name = "version", required = true, example = "1.0.0"),
        @Parameter(name = "form", hidden = true)})
    ...
    @Operation(summary = "nacos.admin.ai.agent.api.force.publish.summary",
        description = "nacos.admin.ai.agent.api.force.publish.description",
        security = @SecurityRequirement(name = "nacos"))
    @ApiResponse(responseCode = "200",
        content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,
            schema = @Schema(implementation = Result.class,
                example = "nacos.admin.ai.agent.api.force.publish.example")))
    @Parameters(value = {@Parameter(name = "namespaceId", example = "public"),
        @Parameter(name = "agentName", required = true, example = "my-agent"),
        @Parameter(name = "version", required = true, example = "1.0.0"),
        @Parameter(name = "form", hidden = true)})
    ...
    @PostMapping("/redraft")
    @Secured(action = ActionTypes.WRITE, signType = SignType.AI, apiType = ApiType.ADMIN_API)
    @Operation(summary = "nacos.admin.ai.agent.api.redraft.summary",
        description = "nacos.admin.ai.agent.api.redraft.description",
        security = @SecurityRequirement(name = "nacos"))
    @ApiResponse(responseCode = "200",
        content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,
            schema = @Schema(implementation = Result.class,
                example = "nacos.admin.ai.agent.api.redraft.example")))
    @Parameters(value = {@Parameter(name = "namespaceId", example = "public"),
        @Parameter(name = "agentName", required = true, example = "my-agent"),
        @Parameter(name = "version", required = true, example = "1.0.0"),
        @Parameter(name = "form", hidden = true)})
    ...
    @PostMapping("/online")
    @Secured(action = ActionTypes.WRITE, signType = SignType.AI, apiType = ApiType.ADMIN_API)
    @Operation(summary = "nacos.admin.ai.agent.api.online.summary",
        description = "nacos.admin.ai.agent.api.online.description",
        security = @SecurityRequirement(name = "nacos"))
    @ApiResponse(responseCode = "200",
        content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,
            schema = @Schema(implementation = Result.class,
                example = "nacos.admin.ai.agent.api.online.example")))
    @Parameters(value = {@Parameter(name = "namespaceId", example = "public"),
        @Parameter(name = "agentName", required = true, example = "my-agent"),
        @Parameter(name = "version", required = true, example = "1.0.0"),
        @Parameter(name = "form", hidden = true)})
    ...
    @PostMapping("/offline")
    @Secured(action = ActionTypes.WRITE, signType = SignType.AI, apiType = ApiType.ADMIN_API)
    @Operation(summary = "nacos.admin.ai.agent.api.offline.summary",
        description = "nacos.admin.ai.agent.api.offline.description",
        security = @SecurityRequirement(name = "nacos"))
    @ApiResponse(responseCode = "200",
        content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,
            schema = @Schema(implementation = Result.class,
                example = "nacos.admin.ai.agent.api.offline.example")))
    @Parameters(value = {@Parameter(name = "namespaceId", example = "public"),
        @Parameter(name = "agentName", required = true, example = "my-agent"),
        @Parameter(name = "version", required = true, example = "1.0.0"),
        @Parameter(name = "form", hidden = true)})
    ...
    @PutMapping("/labels")
    @Secured(action = ActionTypes.WRITE, signType = SignType.AI, apiType = ApiType.ADMIN_API)
    @Operation(summary = "nacos.admin.ai.agent.api.labels.update.summary",
        description = "nacos.admin.ai.agent.api.labels.update.description",
        security = @SecurityRequirement(name = "nacos"))
    @ApiResponse(responseCode = "200",
        content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,
            schema = @Schema(implementation = Result.class,
                example = "nacos.admin.ai.agent.api.labels.update.example")))
    @Parameters(value = {@Parameter(name = "namespaceId", example = "public"),
        @Parameter(name = "agentName", required = true, example = "my-agent"),
        @Parameter(name = "labels", required = true, description = "Label JSON object"),
        @Parameter(name = "form", hidden = true)})

  ...
  return (
    <div className="annotations-editor-container" style={{ padding: '0 24px' }}>
      ...
      <FormItem
        ...
        help={
          locale?.idempotentHintHelp ||
          'If true, repeated calls with same arguments have no additional effect (Default: false)'
        }
      >
        <div style={{ display: 'flex', alignItems: 'center' }}>
          <Switch

    ...
    <div className="create-tools-card">
                        ...
                        <Col>
                          <Row>
                            ...
                            {!isArrayItemsNode(args[node.key]) && (
                              <Col
                                style={{ textOverflow: 'ellipsis', marginLeft: 10, color: '#666' }}
                              >
      ...
      {currentNode.key !== '' && currentNode.key !== rootKey && (
        <div className="detail-info-container">
          <h3 className="detail-info-header">{locale.ArgumentInfo || '参数详情'}</h3>
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center' }}>
                    ...
                    <span style={{ marginLeft: 12, color: '#666', fontSize: 12 }}>
                      {currentNode.required ? locale.required || '必填' : locale.optional || '可选'}
                    </span>
                  </div>
                </Form.Item>
              </Col>

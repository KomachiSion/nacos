...
import { Dialog, Field, Form, Message, Tab, Button } from '@alifd/next';
      ...
      {visible ? (
        ...
        >
          <div className="create-tools-dialog-body">
            <Form field={field} {...formitemLayout} className="create-tools-form-container">
              <Tab
                shape="wrapped"
                size="medium"
                style={{ marginTop: 0 }}
